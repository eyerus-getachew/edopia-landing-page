...
export default function DashboardMockup() {
    return (
        <div className="w-full bg-white rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-gray-100 overflow-hidden text-left flex flex-col h-[650px] transform transition-transform duration-700 hover:-translate-y-2 z-10">
            {/* Fake Browser header */}
            ...
            <div className="flex flex-1 overflow-hidden bg-white">
                ...
                <div className="w-[220px] border-r border-gray-100 p-4 flex flex-col hidden lg:flex">
                    ...
                    <div className="flex items-center gap-3 mb-8 p-2 rounded-lg hover:bg-gray-50 cursor-pointer border border-gray-100 shadow-sm">
                        <div className="w-8 h-8 rounded-full bg-teal-100 text-[#64bdbd] flex items-center justify-center font-bold text-xs">HJ</div>
                        <div>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <ul className="space-y-1 text-sm text-gray-600 font-medium">
                                <li className="flex items-center gap-3 p-2 rounded-md hover:bg-gray-50 cursor-pointer bg-gray-50 text-[#64bdbd]"><LayoutDashboard size={16} /> Dashboard</li>
                            ...
                            <ul className="space-y-1 text-sm text-gray-600 font-medium">
                                ...
                                <li className="flex items-center gap-3 p-2 rounded-md hover:bg-gray-50 cursor-pointer justify-between">
                                    <div className="flex items-center gap-3"><Users size={16} /> Community</div>
                                            <span className="text-[9px] bg-teal-50 text-[#64bdbd] border border-teal-100 px-1.5 py-0.5 rounded">New</span>
                                </li>
                    ...
                    <div className="flex justify-between items-start mb-8">
                        <div className="max-w-xl">
                            ...
                            <p className="text-sm text-gray-500 mb-4">
                                Start from <span className="text-[#64bdbd] font-medium">server basics, node.js, express, databases, deployment.</span> Focused path generated by AI based on your form.
                            </p>
                            <div className="flex items-center gap-3">
                                <button className="px-5 py-2 bg-[#64bdbd] hover:bg-[#4a9191] text-white text-sm font-medium rounded-lg transition-colors shadow-sm flex items-center gap-2">
                ...
                <div className="w-[300px] border-l border-gray-100 bg-gray-50/30 flex flex-col hidden xl:flex text-sm">
                    <div className="m-4 p-4 border border-blue-100 bg-white rounded-xl shadow-sm relative">
                        <div className="flex items-center justify-between mb-2">
                            <h4 className="font-bold flex items-center gap-2 text-slate-800 tracking-tight"><div className="w-5 h-5 bg-[#64bdbd] rounded text-white flex items-center justify-center"><LayoutDashboard size={12}/></div> Edopia AI</h4>
                    ...
                    <div className="flex-1 overflow-y-auto px-4 pb-4 flex flex-col gap-4">
                        <div className="flex items-center gap-2 text-[10px] text-gray-400 font-medium">
                                    <div className="w-5 h-5 bg-[#64bdbd] rounded text-white flex items-center justify-center"><LayoutDashboard size={10}/></div> Edopia AI • 10:25 AM
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-[10px] text-gray-400 font-medium">
                            <div className="w-5 h-5 bg-[#64bdbd] rounded text-white flex items-center justify-center"><LayoutDashboard size={10}/></div> Edopia AI • Now
                        </div>
