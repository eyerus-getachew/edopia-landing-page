...
export default function HeroDashboard() {
      ...
      <div className="w-full max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-20">
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-4">
            Get structured courses, instant help, and track your progress—all in one place.
          </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] min-h-[460px]">
                ...
                <div className="hidden md:block border-r border-gray-200 p-4 bg-white">
                  ...
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <div>
                      <p className="text-sm font-semibold">Solomon Tesfaye</p>
                  ...
                  <ul className="space-y-3 text-sm text-gray-600">
                    ...
                    <li className="flex items-center gap-2 hover:text-gray-900 transition">
                      <Target className="w-4 h-4" /> AI Tutor
                    </li>
                    <li className="flex items-center gap-2 hover:text-gray-900 transition">
                ...
                <div className="p-6">
                  ...
                  >
                  Your  Mathematics learning path
                  </motion.h2>

                  <p className="text-sm text-gray-500 mb-4 leading-relaxed">
  Learn step-by-step with{" "}
  <span className="text-[#0891bb]">
    AI-generated lessons and explanations
  </span>
  tailored to your level and goals.
                  ...
                  <p className="text-[11px] text-gray-400 mt-2">
                    Built for your curriculum and learning style
                  </p>
                  ...
                  >
                    ...
                    Understand key concepts with simple explanations, examples, and interactive practice.
                    </p>
